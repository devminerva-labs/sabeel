...
export const ADHKAR_DATA: Dhikr[] = [
  ...
  // ============================================================
  // LAYLATUL QADR ADHKAR (أذكار ليلة القدر)
  // ============================================================
  {
    id: 'laylatul_qadr-01',
    ...
    source: { text: 'Jami at-Tirmidhi 3513', grading: 'Hasan Sahih' },
    repetitions: 100,
    virtue: 'The dua the Prophet (ﷺ) specifically taught Aisha (RA) to say on Laylatul Qadr',
  },
  {
    id: 'laylatul_qadr-02',
    category: 'laylatul_qadr',
    ...
    transliteration: "Astaghfirullāhal-ʿAẓīmalladhī lā ilāha illā Huwal-Ḥayyul-Qayyūmu wa atūbu ilayh",
    translation: 'I seek forgiveness from Allah, the Magnificent, besides Whom there is no deity, the Ever-Living, the Sustainer of existence, and I repent to Him.',
    source: { text: 'Abu Dawud 1517', grading: 'Sahih' },
    repetitions: 100,
    virtue: 'Whoever says this, their sins will be forgiven even if they ran from the battlefield',
  },
  {
    id: 'laylatul_qadr-03',
    category: 'laylatul_qadr',
    ...
    source: { text: 'Al-Bukhari 3370', grading: 'Sahih' },
    repetitions: 100,
    virtue: 'Whoever sends one salawat upon the Prophet (ﷺ), Allah sends ten blessings upon them',
  },
  {
    id: 'laylatul_qadr-04',
    category: 'laylatul_qadr',
    ...
    source: { text: 'Al-Bukhari 6682, Muslim 2694', grading: 'Sahih' },
    repetitions: 100,
    virtue: 'Two words light on the tongue, heavy on the scale, beloved to the Most Merciful',
  },
  {
    id: 'laylatul_qadr-05',
    category: 'laylatul_qadr',
  ...
  },
  {
    ...
    source: { text: 'Muslim 223', grading: 'Sahih' },
    repetitions: 100,
    virtue: 'Fills the entire scale of good deeds',
  },
  {
    id: 'laylatul_qadr-07',
    category: 'laylatul_qadr',
    ...
    transliteration: 'Allāhu Akbar',
    translation: 'Allah is the Greatest.',
    source: { text: 'Al-Bukhari 6043', grading: 'Sahih' },
    repetitions: 100,
  ...
  },
  {
    ...
    source: { text: 'Jami at-Tirmidhi 3383', grading: 'Sahih' },
    repetitions: 100,
    virtue: 'The best dhikr — the best thing the Prophets and I have said',
  },
]
...
export const CATEGORIES: { id: AdhkarCategory; label: string; labelAr: string; icon: string }[] = [
  ...
  { id: 'laylatul_qadr', label: 'Laylatul Qadr', labelAr: 'أذكار ليلة القدر', icon: '✦' },
]
